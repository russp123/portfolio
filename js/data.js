...
const PORTFOLIO = {
  ...
  projects: [
    ...
    },
    {
      id: "configurator",
      niche: "web",
      llm: "Interactive Dome Builder (the Kingdomes product configurator) — a live product configurator on kingdomes.com.au: a 7-step guided flow (range, size, colours, upgrades, chimney, specs, quote) across two dome ranges and seven sizes, real-time multi-currency pricing (AUD/USD/NZD), and quote submissions posted straight into GoHighLevel as structured CRM leads. Built as a single self-contained HTML file with zero dependencies.",
      title: "Interactive Dome Builder",
